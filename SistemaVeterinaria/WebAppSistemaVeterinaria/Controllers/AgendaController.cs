...
namespace WebAppSistemaVeterinaria.Controllers
{
    public class AgendaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Fecha,Comentarios,Disponible")] Agenda agenda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Fecha,Comentarios,Disponible")] Agenda agenda)
        {
            if (id != agenda.Id)
            {
                return NotFound();
